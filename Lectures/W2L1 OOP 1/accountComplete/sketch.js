...
class Password {
     ...
     * @throws Throws an error if the password does not meet security requirements
     */
    constructor(pwd) {
        if (Password.meetsRequirements(pwd)) {
            this.#password = pwd;
        }
        else {
            throw `${pwd} does not meet security requirements!`
        }
    }
